// AUTO-GENERATED from tweaks-panel.jsx by build.py — do not edit directly.
'use strict';
...
function useTweaks(defaults) {
  ...
  var setTweak = React.useCallback(function (keyOrEdits, val) {
    var edits = (typeof keyOrEdits === 'undefined' ? 'undefined' : _typeof(keyOrEdits)) === 'object' && keyOrEdits !== null ? keyOrEdits : _defineProperty({}, keyOrEdits, val);
...
function TweaksPanel(_ref2) {
  var _ref2$title = _ref2.title,
      title = _ref2$title === undefined ? 'Tweaks' : _ref2$title,
  ...
  var offsetRef = React.useRef({ x: 16, y: 16 });
  var PAD = 16;
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      { ref: dragRef, className: 'twk-panel', 'data-omelette-chrome': '',
        style: { right: offsetRef.current.x, bottom: offsetRef.current.y } },
      React.createElement(
        'div',
        { className: 'twk-hd', onMouseDown: onDragStart },
        React.createElement(
          'b',
          null,
          title
...
function TweakSlider(_ref5) {
  var label = _ref5.label,
      ...
      _ref5$max = _ref5.max,
      max = _ref5$max === undefined ? 100 : _ref5$max,
      _ref5$step = _ref5.step,
      step = _ref5$step === undefined ? 1 : _ref5$step,
      _ref5$unit = _ref5.unit,
      unit = _ref5$unit === undefined ? '' : _ref5$unit,
...
function TweakRadio(_ref7) {
  ...
  var labelLen = function labelLen(o) {
    return String((typeof o === 'undefined' ? 'undefined' : _typeof(o)) === 'object' ? o.label : o).length;
  };
  var maxLen = options.reduce(function (m, o) {
    return Math.max(m, labelLen(o));
  }, 0);
  var fitsAsSegments = maxLen <= ({ 2: 16, 3: 10 }[options.length] || 0);
  if (!fitsAsSegments) {
    // <select> emits strings — map back to the original option value so the
    // fallback stays type-preserving (numbers, booleans) like the segment path.
    var resolve = function resolve(s) {
      var m = options.find(function (o) {
        return String((typeof o === 'undefined' ? 'undefined' : _typeof(o)) === 'object' ? o.value : o) === s;
      });
      return m === undefined ? s : (typeof m === 'undefined' ? 'undefined' : _typeof(m)) === 'object' ? m.value : m;
    };
    return React.createElement(TweakSelect, { label: label, value: value, options: options,
      onChange: function onChange(s) {
        return _onChange2(resolve(s));
      } });
  }
  var opts = options.map(function (o) {
    return (typeof o === 'undefined' ? 'undefined' : _typeof(o)) === 'object' ? o : { value: o, label: o };
  });
...
function TweakSelect(_ref8) {
  ...
  return React.createElement(
    ...
    React.createElement(
      'select',
      { className: 'twk-field', value: value, onChange: function onChange(e) {
          return _onChange3(e.target.value);
        } },
      options.map(function (o) {
        var v = (typeof o === 'undefined' ? 'undefined' : _typeof(o)) === 'object' ? o.value : o;
        var l = (typeof o === 'undefined' ? 'undefined' : _typeof(o)) === 'object' ? o.label : o;
        return React.createElement(
          'option',
          { key: v, value: v },
          l
...
function TweakNumber(_ref10) {
  var label = _ref10.label,
      value = _ref10.value,
      min = _ref10.min,
      max = _ref10.max,
      _ref10$step = _ref10.step,
      step = _ref10$step === undefined ? 1 : _ref10$step,
      _ref10$unit = _ref10.unit,
      unit = _ref10$unit === undefined ? '' : _ref10$unit,
  ...
  var startRef = React.useRef({ x: 0, val: 0 });
  ...
  return React.createElement(
    ...
    React.createElement(
      'span',
      { className: 'twk-num-lbl', onPointerDown: onScrubStart },
      label
    ),
...
var __TwkCheck = function __TwkCheck(_ref11) {
...
function TweakColor(_ref12) {
  var label = _ref12.label,
      value = _ref12.value,
      options = _ref12.options,
      _onChange6 = _ref12.onChange;
    ...
    React.createElement(
      ...
      options.map(function (o, i) {
        ...
        return React.createElement(
          ...
          sup.length > 0 && React.createElement(
            'span',
            null,
            sup.map(function (c, j) {
              return React.createElement('i', { key: j, style: { background: c } });
            })
          ),
...
function TweakButton(_ref13) {
  var label = _ref13.label,
      onClick = _ref13.onClick,
      _ref13$secondary = _ref13.secondary,
      secondary = _ref13$secondary === undefined ? false : _ref13$secondary;

  return React.createElement(
    'button',
    { type: 'button', className: secondary ? 'twk-btn secondary' : 'twk-btn',
      onClick: onClick },
    label
  );
}
...
Object.assign(window, {
  useTweaks: useTweaks, TweaksPanel: TweaksPanel, TweakSection: TweakSection, TweakRow: TweakRow,
  TweakSlider: TweakSlider, TweakToggle: TweakToggle, TweakRadio: TweakRadio, TweakSelect: TweakSelect,
  TweakText: TweakText, TweakNumber: TweakNumber, TweakColor: TweakColor, TweakButton: TweakButton
});